...
var amount = 0; if random(oCamera.zoom) >= 0.045 && random(1) < 0.1 amount = 1;

part_emitter_region(global.partSystem,emitterSnow,cam_x, cam_x + cam_width, cam_y-100, cam_y-20, ps_shape_rectangle, ps_distr_linear);
