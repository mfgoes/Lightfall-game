...
// Generated at 2020-12-01 01:49:06 (9947ms) for v2.3+
...
function gml_builder(l_pg,l_src)constructor{
	...
	static h_build_expr=function(l_flags){
		...
		switch(l_tk0.__enumIndex__){
			...
			case 10:
				...
				break;
			case 26:self.h_out_node=gml_node_arg_const(l_tk0.h_d,l_tk0.h_i);break;
			case 15:
			...
			case 24:
				...
				var l__g=self.h_tokens[self.h_offset];
				var l_tmp;
				if(l__g.__enumIndex__==25)l_tmp=true; else l_tmp=false;
				if(l_tmp){
					self.h_offset+=1;
					...
					switch(l__g.__enumIndex__){
						case 14:
							...
							switch(self.h_tokens[self.h_offset].__enumIndex__){
								case 4:
									self.h_offset+=1;
									if(self.h_tokens[self.h_offset].__enumIndex__==25){
										self.h_offset+=1;
										l_proc=false;
									}
									break;
			...
			case 9:
				switch(l_tk0.h_kw){
					...
					case 24:
						...
						var l__g1=self.h_tokens[self.h_offset];
						if(l__g1.__enumIndex__==24)var l__g2=l__g1.h_d; else return self.h_error("expected a `{`",self.h_tokens[self.h_offset]);
						self.h_build_line();
			...
			switch(l_tk.__enumIndex__){
				...
				case 15:
					if(l_tk.h_op==1){
						...
						if((l_flags&2)==0){
							self.h_offset+=1;
							if(self.h_tokens[self.h_offset].__enumIndex__==16){
								l_node=self.h_out_node;
								self.h_offset+=1;
								if(self.h_build_expr(1))return true;
			...
			case 9:
				...
				switch(l_tk.h_kw){
					...
					case 3:
						...
						} else if(self.h_tokens[self.h_offset].__enumIndex__==24){
							self.h_offset+=1;
					...
					case 14:
						...
						l_x2=self.h_out_node;
						if(l_proc){
							if(self.h_tokens[self.h_offset].__enumIndex__==21)self.h_offset+=1; else return self.h_expect("a closing parenthesis",self.h_tokens[self.h_offset]);
						}
						if(self.h_build_line())return true;
					...
					case 18:
						...
						if(self.h_offset<self.h_length){
							var l__g1=self.h_tokens[self.h_offset];
							switch(l__g1.__enumIndex__){
								case 25:self.h_out_node=gml_node_exit(l__g1.h_d);break;
	...
	static h_build_outer=function(l_name,l_namedArgs,l_namedArgc,l_isFunc){
		...
		while(self.h_offset<self.h_length){
			var l__g=self.h_tokens[self.h_offset];
			switch(l__g.__enumIndex__){
				case 0:var l__name=l__g.h_name;break;
				case 9:
					if(l__g.h_kw!=24){
						if(self.h_build_line())return true;
						gml_std_gml_internal_ArrayImpl_push(l_nodes,self.h_out_node);
	...
	static h_build_script_args=function(){
		...
		var l__g=self.h_tokens[self.h_offset];
		var l_tmp;
		if(l__g.__enumIndex__==21)l_tmp=true; else l_tmp=false;
		if(l_tmp){
			self.h_offset+=1;
		} else while(l_proc&&self.h_offset<self.h_length){
			var l__g=self.h_tokens[self.h_offset];
			...
			switch(l_tk.__enumIndex__){
				case 0:
					...
					if(!(l_tk.h_lb||self.h_offset>=self.h_length)){
						var l__g1=self.h_tokens[self.h_offset];
						var l_tmp;
						if(l__g1.__enumIndex__==20)l_tmp=true; else l_tmp=false;
						if(l_tmp){
							self.h_offset+=1;
							if(self.h_build_script_args())return true;
				...
				case 9:
					if(l_tk.h_kw==24){
						...
						l_tk=self.h_tokens[self.h_offset++];
						var l_tmp1;
						if(l_tk.__enumIndex__==20)l_tmp1=true; else l_tmp1=false;
	...
	switch(l__g.__enumIndex__){
		...
		case 101:
			...
			for(l_k=l_p0;l_k<l_p2;l_k++){
				var l__g1=l_r[|l_k];
				switch(l__g1.__enumIndex__){
					case 70:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p1);break;
					case 69:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p2);break;
				}
			}
		...
		case 98:
			...
			for(l_k=l_p1;l_k<l_p2;l_k++){
				var l__g1=l_r[|l_k];
				switch(l__g1.__enumIndex__){
					case 70:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p0);break;
					case 69:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p2);break;
				}
			}
			break;
		...
		case 102:
			...
			for(l_k=l_p1;l_k<l_p2;l_k++){
				var l__g1=l_r[|l_k];
				switch(l__g1.__enumIndex__){
					case 70:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p2);break;
					case 69:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p3);break;
				}
			}
			break;
		case 95:
		...
		case 103:
			...
			for(l_k=l_p0;l_k<l_p1;l_k++){
				...
				switch(l__g1.__enumIndex__){
					case 70:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p0);break;
					case 69:if(l__g1.h_lp==l_p0)l_r[|l_k]=gml_action_jump(l__g1.h_d,l_p1);break;
				}
			}
			break;
		case 110:
	...
	static h_destroy=function(){
		...
		if(self.h_actions!=undefined){
			...
			for(var l__g1=ds_list_size(l_this1);l_i<l__g1;l_i++){
				var l_q=l_this1[|l_i];
				if(l_q.__enumIndex__==62)ds_map_destroy(l_q.h_jumptable);
			}
...
if(live_enabled)
global.__mp_gml_token_env=["h_d","h_id"];
if(live_enabled)
function mc_gml_token_env():mc_gml_token()constructor{
	static __enumParams__=global.__mp_gml_token_env;
	static __enumIndex__=11;
}

if(live_enabled)
function gml_token_env(l_h_d,l_h_id){
...
if(live_enabled)
global.__mp_gml_token_in=["h_d"];
if(live_enabled)
function mc_gml_token_in():mc_gml_token()constructor{
	static __enumParams__=global.__mp_gml_token_in;
	static __enumIndex__=16;
}

if(live_enabled)
function gml_token_in(l_h_d){
...
if(live_enabled)
global.__mp_gml_token_comment_post=["h_d","h_s"];
if(live_enabled)
function mc_gml_token_comment_post():mc_gml_token()constructor{
	static __enumParams__=global.__mp_gml_token_comment_post;
	static __enumIndex__=27;
}

if(live_enabled)
function gml_token_comment_post(l_h_d,l_h_s){
...
if(live_enabled)
global.__mp_gml_token_comment_line=["h_d","h_s"];
if(live_enabled)
function mc_gml_token_comment_line():mc_gml_token()constructor{
	static __enumParams__=global.__mp_gml_token_comment_line;
	static __enumIndex__=28;
}

if(live_enabled)
function gml_token_comment_line(l_h_d,l_h_s){
...
if(live_enabled)
global.__mp_gml_token_comment_block=["h_d","h_s","h_pl"];
if(live_enabled)
function mc_gml_token_comment_block():mc_gml_token()constructor{
	static __enumParams__=global.__mp_gml_token_comment_block;
	static __enumIndex__=29;
}

if(live_enabled)
function gml_token_comment_block(l_h_d,l_h_s,l_h_pl){
		...
		for(var l__g1=l_argc;l_i<l__g1;l_i++){
			...
			if(l_pos>=0){
				...
				if(l_tmap.h_exists(l_type)){
					...
					if(gml_std_string_pos_ext_haxe(l_arg,"...")>=0)l_rest=l_tfun1;
					l_argt[@l_i]=l_tfun1;
...
if(live_enabled)
global.__mp_gml_action_object_decl=["h_d","h_keys","h_sig"];
if(live_enabled)
...
if(live_enabled)
function gml_action_object_decl(l_h_d,l_h_keys,l_h_sig){
...
if(live_enabled)
global.__mp_gml_action_add_op=["h_d"];
if(live_enabled)
function mc_gml_action_add_op():mc_gml_action()constructor{
	static __enumParams__=global.__mp_gml_action_add_op;
	static __enumIndex__=44;
}

if(live_enabled)
function gml_action_add_op(l_h_d){
...
if(live_enabled)
global.__mp_gml_action_call_script_at=["h_d","h_script","h_argc"];
if(live_enabled)
function mc_gml_action_call_script_at():mc_gml_action()constructor{
	static __enumParams__=global.__mp_gml_action_call_script_at;
	static __enumIndex__=52;
}

if(live_enabled)
function gml_action_call_script_at(l_h_d,l_h_script,l_h_argc){
