...
function init_weapon_variables(){
	...
	// Weapons
	none = new Weapon("No weapon", sBow_Slimmer, ammo_basic, 0, 0, 0, 0);
    bow = new Weapon("Bow", sBow_Slimmer, ammo_basic, 30, 2, 0, 1);
    fast_gun = new Weapon("Fast Gun", sGun, ammo_basic, 30, 3, 0, 2);
    heavy_gun = new Weapon("Heavy Gun", sGun, ammo_heavy, 30, 4, 1, 3);
    explosive_gun = new Weapon("Explosive Gun", sGun, ammo_explosive, 30, 5, 2, 3);
    bazooka = new Weapon("Bazooka", sGun, ammo_explosive, 30, 8, 4, 3);
...
function Weapon(_name, _sprite_index, _ammoType, _reload_time, _kickbackX, _kickbackY,_icon_image) constructor {
    weapon_name = _name;
